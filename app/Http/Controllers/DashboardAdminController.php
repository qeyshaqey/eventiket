...
class DashboardAdminController extends Controller
{
    public function index()
    {
        ...
        $categories = Kategori::withCount('events')->get();
        ...
        $events = [
            ...
            ["tanggal"=>"20 Aug","nama"=>"Startup Pitch","kategori"=>"Bisnis","waktu"=>"14:00","lokasi"=>"Aula","deskripsi"=>"Presentasi id startup kepada investor dan mentor."],
